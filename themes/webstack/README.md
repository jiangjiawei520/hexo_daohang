...
[中文文档](https://xxxxxx/blob/master/README_CN.md)

> A Hexo theme based on [WebStackPage](https://github.com/WebStackPage/WebStackPage.github.io).

![screenshot](https://xxxxxx/raw/master/screenshot/screenshot.png)
...
```shell
git clone https://xxxxxx themes/webstack
```
...
aboutPage:
  website:
    head: 关于本站
    html: '<blockquote><p>本站是hexo主题<a href="https://xxxxxx">hexo-theme-webstack</a>的demo站。</p></blockquote>'
  webmaster:
    head: 关于站长
    name: HCLonely
